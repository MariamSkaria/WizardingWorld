...
def sortinghouse():
    ...
    print("""\nQuestion 1:You are trapped in a burning building and only 10 seconds to get out.What would you do?\n(a) Save myself,of course!\n(b) Run and grab my friend who is still in the building.\n(c) It depends, if I have a way to save my friends,then yes, but if there's no way,then I am above everbody else.\n(d) I'll try, but i am not sure!\n""")
    q_1=input("Answer:")
    if q_1=='d':
        gryffindor+=1
    elif q_1=='b':
